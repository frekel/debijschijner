<section class="cms-section cms-homepage-tekst">
        ...
        <span>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 84.94" preserveAspectRatio="none">
                <path
                    ...
                    style="fill-rule:evenodd;opacity:0.33"
                ></path>
                <path
                    ...
                    style="fill-rule:evenodd;opacity:0.66"
                ></path>
                <path
    ...
    <div class="cms-container">
        <div class="grid-row">
            ...
            <div class="grid-col grid-col-6 grid-md-6">
                <div class="cms-copy">
                    <div class="cms-richtext">{!! nl2br(e($text)) !!}</div>
                </div>
            </div>
        </div>
    </div>
